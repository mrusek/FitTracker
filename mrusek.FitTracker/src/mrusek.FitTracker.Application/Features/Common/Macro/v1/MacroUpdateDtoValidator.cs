...
public class MacroUpdateDtoValidator:AbstractValidator<MacroUpdateDto>
{
    public MacroUpdateDtoValidator()
    {
        ...
        RuleFor(x=>x.Salt).NotEmpty().GreaterThanOrEqualTo(x=>x.Salt);
